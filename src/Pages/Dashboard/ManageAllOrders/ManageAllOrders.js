...
const ManageAllOrders = () => {
  ...
  useEffect(() => {
    fetch('https://morning-brook-90186.herokuapp.com/manageAllOrders')
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleCancelOrder = (id) => {
    swal({
      ...
      if (willDelete) {
        fetch(`https://morning-brook-90186.herokuapp.com/deleteOrders/${id}`, {
          method: 'DELETE',
          headers: {
  ...
  const handleApproveOrder = (id) => {
    ...
    fetch(`https://morning-brook-90186.herokuapp.com/manageAllOrders/${id}`, {
      method: 'PUT',
      headers: {
        'content-type': 'application/json',
      },
